...
local Win = Link:CreateWindow('  // Sections //             Magic Champions! 🧙          v3.75','DragulaHub') -- :CreateWindow(Title,Info) Note: info no space
--
...
--
UPAdded:addLabel('(🔨) Last Updated:','(📆) 20th JUNE 2022')
UPAdded:addLabel('❓❓ What is new❓❓','↘⬇↙')
UPAdded:addLabel('NEW','+ added new codes')
UPAdded:addLabel(' ')
...
local args = {[1] = "Codes",[2] = "CosmoMagic"}
game:GetService("ReplicatedStorage").Server:FireServer(unpack(args))
end
local args = {[1] = "Codes",[2] = "50kGroup"}
game:GetService("ReplicatedStorage").Server:FireServer(unpack(args))
end
local args = {[1] = "Codes",[2] = "BIGGEST_UPDATE_COOL"}
game:GetService("ReplicatedStorage").Server:FireServer(unpack(args))
end
local args = {[1] = "Codes",[2] = "25kFavs"}
game:GetService("ReplicatedStorage").Server:FireServer(unpack(args))
end
local args = {[1] = "Codes",[2] = "2MVISITS"}
game:GetService("ReplicatedStorage").Server:FireServer(unpack(args))
end
local args = {[1] = "Codes",[2] = "DRACONAR"}
game:GetService("ReplicatedStorage").Server:FireServer(unpack(args))
end
